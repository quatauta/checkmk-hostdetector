module CheckMK
  ...
  # examples.
  #
  # All configuration values from YAML-file are accessible through methods named the same
  # way as the configuration values.
  class Configuration
    ...
    # Define methods to access the configuration values for the environment set on object
    # initialization
